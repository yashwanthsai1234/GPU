...
int main (int argc, char *argv[])
{
    ...
    /*************************************************************************/
    int mallocate = sizeof(float) * mat_sz;
    cudaMalloc((void **)&A_d, mallocate);
    cudaMalloc((void **)&B_d, mallocate);
    cudaMalloc((void **)&C_d, mallocate);
    ...
    /*************************************************************************/
     cudaMemcpy(A_d,A_h,mallocate, cudaMemcpyHostToDevice);
     cudaMemcpy(B_d,B_h,mallocate, cudaMemcpyHostToDevice); 
    ...
    /*************************************************************************/
    cudaMemcpy(C_h,C_d,mallocate,cudaMemcpyDeviceToHost);
